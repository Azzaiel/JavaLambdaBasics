...
//	public static final Long PSP_PERMISSION_ID_VIEW_ALL_PROJECTS = 15l;
	...
	public static final String MAILING_LIST_TEST_SERVER = "kmojica@virtela.net, rreyles@virtela.net, cproost@virtela.net, psra@virtela.net, jplaton@virtela.net, amadrelejos@virtela.net, slokhande@virtela.net, masharma@virtela.net, jimshah@virtela.net, vnadal@virtela.net, rdhole@virtela.net";
	...
	public static final String PSP_DEV_MAILING_LIST = "rreyles@virtela.net, kmojica@virtela.net, rbaraquio@virtela.net, slokhande@virtela.net";
	...
	public static final String SECURITY_TOKEN_HEADER = "Security-Token";
	...
	public static final String PORT_SPEED_HEADER = "Port Speed";
